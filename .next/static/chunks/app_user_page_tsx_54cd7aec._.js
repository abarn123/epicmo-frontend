...
_s2(AddUserModal, "0tUjunhamt6sg9q01rh4S+g5NL8=");
_c2 = AddUserModal;
function UserManagement({ users: initialUsers = [], onEdit, onDelete, onAdd }) {
    ...
    const fetchUsers = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "UserManagement.useCallback[fetchUsers]": async ()=>{
            ...
            setError(null);
            try {
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${API_BASE_URL}/data1`);
                ...
                const processedUsers = usersData.map({
                    "UserManagement.useCallback[fetchUsers].processedUsers": (u, index)=>{
                ...
                }["UserManagement.useCallback[fetchUsers].processedUsers"]);
                // Periksa duplikasi ID setelah pemrosesan
                const idSet = new Set();
                const uniqueUsers = [];
                processedUsers.forEach({
                    "UserManagement.useCallback[fetchUsers]": (user)=>{
    ...
    const handleSaveNewUser = async (newUser)=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`${API_BASE_URL}/data1`, newUser);
    ...
    const handleSaveEditedUser = async (editedUser)=>{
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put(`${API_BASE_URL}/data1/${editedUser.id}`, editedUser);
    ...
    const handleDeleteUser = async (userId)=>{
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete(`${API_BASE_URL}/data1/${userId}`);
...
_s3(UserManagement, "ar6oKo7c5NzDQkEpauiioRaH1lE=", false, function() {
    return [
