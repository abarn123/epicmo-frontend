...
_s(UserCard, "J0x57dwlEgBqfQlYExuJ2cWLlp8=");
_c = UserCard;
...
_s1(EditUserModal, "MeXawg0Cfu8LYLjUQnjU7WTuHf4=");
_c1 = EditUserModal;
...
function UserManagement() {
        ...
        "UserManagement.useEffect": ()=>{
            const fetchUsers = {
                "UserManagement.useEffect.fetchUsers": async ()=>{
                    try {
                        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get("/data1");
                        ...
                        // OK
                            ...
                            if (Array.isArray(usersData.data)) {
                                ...
                                const arr = Object.values(usersData).find({
                                    "UserManagement.useEffect.fetchUsers.arr": (v)=>Array.isArray(v)
                                }["UserManagement.useEffect.fetchUsers.arr"]);
                                if (arr) {
                                    usersData = arr;
                                } else {
                                    usersData = [];
    ...
    const handleSaveNewUser = async (newUser)=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("/data1", newUser);
            const createdUser = {
                ...newUser,
    ...
    const handleSaveEditedUser = async (editedUser)=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put(`/data1/${editedUser.id}`, editedUser);
    ...
    const handleDeleteUser = async (userId)=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete(`/data1/${userId}`);
                ...
                children: [
                    ...
                    filteredUsers.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            users.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: currentUsers.map((user)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(UserCard, {
                                        user: user,
...
_s3(UserManagement, "NYwLpLPfm7JkJrmvJGCpphLQ8KI=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
...
__turbopack_context__.k.register(_c2, "AddUserModal");
__turbopack_context__.k.register(_c3, "UserManagement");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=_78f988cd._.js.map