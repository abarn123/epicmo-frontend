...
function UserManagement() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const fetchUsers = async ()=>{
            try {
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get("/data1");
                console.log("API Response:", response.data);
                let usersData = response.data;
                // Adaptasi agar lebih toleran terhadap struktur response
                ...
                // OK
                    ...
                    if (Array.isArray(usersData.data)) {
                        ...
                        // Coba cari array pertama yang ditemukan di object
                        const arr = Object.values(usersData).find((v)=>Array.isArray(v));
                        if (arr) {
                            usersData = arr;
                        } else {
                            usersData = [];
                ...
                // Tidak error, hanya warning jika kosong
                if (!Array.isArray(usersData)) {
                    console.warn("API did not return an array of users, fallback to empty array");
                    usersData = [];
                }
                ...
                // Optional: warning jika duplikat, tapi tidak error
                const idSet = new Set();
                ...
                if (duplicates.length > 0) {
                    console.warn("Duplicate users found:", duplicates);
                }
    ...
    const handleSaveNewUser = async (newUser)=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post("/data1", newUser);
            const createdUser = {
                ...newUser,
    ...
    const handleSaveEditedUser = async (editedUser)=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].put(`/data1/${editedUser.id}`, editedUser);
    ...
    const handleDeleteUser = async (userId)=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].delete(`/data1/${userId}`);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1bf401f2._.js.map