          ...
          <div>
            <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8 gap-4">
              ...
              <div className="mb-4 md:mb-0 md:ml-4 flex justify-end gap-3">
                ...
                <Link
                  href="/log_tools/add"
                  className="px-5 py-2.5 bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-700 flex items-center mr-6"
                >
                  <svg
                    className="w-5 h-5 mr-2"
                    fill="none"
            ...
            <div className="mb-6">
              <div className="relative max-w-md mr-6">
              ...
              className="pl-10 pr-4 py-2.5 w-full rounded-lg border border-gray-300 text-black focus:ring-2 focus:ring-blue-500 focus:border-blue-500 mr-4"
                />
              </div>
            </div>
            ...
            {filteredRecords.length === 0 ? (
              ...
              <div className="flex flex-col min-h-[500px] space-y-4 mr-6">
                {/* Mobile cards */}
