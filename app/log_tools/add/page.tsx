    ...
    useEffect(() => {
      const fetchTools = async () => {
        try {
          ...
          // Debug log untuk melihat struktur respons
          ...
          if (
            ...
            // Jika respons section, misal: { sectionA: [...], sectionB: [...] }
            // Gabungkan semua array section jadi satu array alat
                    ...
                    <div className="col-span-6 sm:col-span-4">
                      ...
                      >
                        <option value="" className="text-black">
                          {loadingTools ? "Memuat data alat..." : "Pilih Alat"}
                        </option>
                        {tools.map((tool) => (
                          <option
                            key={tool.id}
